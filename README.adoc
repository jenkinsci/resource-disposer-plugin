...
link:https://ci.jenkins.io/job/Plugins/job/resource-disposer-plugin/job/master/[image:https://ci.jenkins.io/buildStatus/icon?job=Plugins%2Fresource-disposer-plugin%2Fmaster[Build Status]]
